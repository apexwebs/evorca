      ...
      <div className="max-w-7xl mx-auto px-6 py-4 flex justify-between items-center">
        ...
        <div className="flex items-center gap-4">
          ...
          <button
            ...
            className="flex items-center gap-3 p-1 pl-3 bg-surface-container-low rounded-full hover:bg-surface-container-high transition-all border border-outline-variant/5"
          >
